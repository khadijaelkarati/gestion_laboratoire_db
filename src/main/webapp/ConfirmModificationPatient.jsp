...
<head>
    ...
    <link rel="stylesheet" href="StyleConfirmUpdate.css?v=1.0">
</head>
<body>
<%
...
<div class="confirm-modal">
    ...
    <div class="confirm-body">
        ...
        <!-- Icône de succès (en utilisant confirm-icon) -->
        <div class="confirm-icon">
            <i class="fas fa-check-circle"></i>
        </div>
        
        <!-- Titre -->
        <h3>Patient modifié avec succès !</h3>
        
        <!-- Informations patient (en utilisant confirm-patient-info) -->
        ...
        <!-- Message de confirmation (en utilisant confirm-message) -->
